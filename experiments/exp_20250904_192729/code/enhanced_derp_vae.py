...
class EnhancedDERP_VAE(nn.Module):
    """
    ...
    def __init__(self, input_dim: int = 256, hidden_dim: int = 128, latent_dim: int = 4, 
        ...
        self.encoder = EnhancedVAEEncoder(input_dim, hidden_dim, latent_dim)
        self.decoder = EnhancedVAEDecoder(latent_dim, hidden_dim, input_dim)
