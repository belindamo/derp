...
% Note: Actual experimental figures available in:
...
\begin{figure}[ht]
\centering
% \includegraphics[width=0.9\textwidth]{../experiments/exp_20250904_192729 cifar/results/experiment_results.png}
...
\begin{figure}[ht]
\centering
% \includegraphics[width=0.9\textwidth]{../experiments/exp_20250904_20000 celeba all/results/celeba_results.png}
\fbox{\parbox{0.9\textwidth}{\centering
